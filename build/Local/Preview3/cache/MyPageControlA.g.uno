public partial class MyPageControlA: Fuse.Controls.PageControl
{
    ...
    internal new void InitializeUX()
    {
        ...
        var temp15 = new Fuse.Drawing.StaticSolidColor(float4(0f, 1f, 0.8f, 1f));
        var temp16 = new Fuse.Controls.Page();
        var temp17 = new Fuse.Controls.Text();
        var temp18 = new Fuse.Drawing.StaticSolidColor(float4(0.8f, 0f, 1f, 1f));
        ...
        temp4.LineNumber = 2;
        temp4.FileName = "C:\\Users\\TNeuraz\\Documents\\Perso\\FuseApp\\MyPageControlA.ux";
