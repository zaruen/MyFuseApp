public partial class MainView: Fuse.App
{
    ...
    internal void InitializeUX()
    {
        ...
        var temp13 = new MyPageControlA();
        _b = new Fuse.Controls.PageControl();
        var temp14 = new Fuse.Controls.Page();
        var temp15 = new Fuse.Controls.Text();
        var temp16 = new Fuse.Drawing.StaticSolidColor(float4(0.8f, 1f, 0f, 1f));
        var temp17 = new Fuse.Controls.Page();
        var temp18 = new Fuse.Controls.Text();
        var temp19 = new Fuse.Drawing.StaticSolidColor(float4(0f, 0.8f, 1f, 1f));
        var temp20 = new Fuse.Controls.Page();
        var temp21 = new Fuse.Controls.Text();
        var temp22 = new Fuse.Drawing.StaticSolidColor(float4(1f, 0f, 0.8f, 1f));
        ...
        _b.Name = "_b";
        _b.Children.Add(temp14);
        _b.Children.Add(temp17);
        _b.Children.Add(temp20);
