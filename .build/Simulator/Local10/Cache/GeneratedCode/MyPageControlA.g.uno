public partial class MyPageControlA: Fuse.Controls.PageControl
{
    ...
    public partial class Factory: Uno.UX.IFactory
    {
        ...
        public Factory(MyPageControlA parent)
        {
            __parent = parent;
        }
        MyPageControlA.Fuse_Controls_TextControl_string_Value_Property self_Value_inst;
        static Factory()
        {
        }
        public object New()
        {
            ...
            self_Value_inst = new MyPageControlA.Fuse_Controls_TextControl_string_Value_Property(self);
    ...
    {
        internal readonly MyPageControlA __parent;
        public Factory1(MyPageControlA parent)
        {
            __parent = parent;
        }
        MyPageControlA.Fuse_Controls_TextControl_string_Value_Property self_Value_inst;
    ...
    MyPageControlA.Fuse_Reactive_Each_object_Items_Property temp4_Items_inst;
    ...
    internal new void InitializeUX()
    {
        ...
        temp4_Items_inst = new MyPageControlA.Fuse_Reactive_Each_object_Items_Property(temp4);
        ...
        temp5.LineNumber = 2;
        temp5.FileName = "MyPageControlA.ux";
