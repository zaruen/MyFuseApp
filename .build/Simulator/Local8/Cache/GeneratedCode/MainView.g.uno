public partial class MainView: Fuse.App
{
    ...
    internal void InitializeUX()
    {
        ...
        var temp15 = new Fuse.Drawing.StaticSolidColor(float4(1f, 0.8f, 0f, 1f));
        var temp16 = new Fuse.Controls.Page();
        var temp17 = new Fuse.Controls.Text();
        var temp18 = new Fuse.Drawing.StaticSolidColor(float4(0f, 1f, 0.8f, 1f));
        var temp19 = new Fuse.Controls.Page();
        var temp20 = new Fuse.Controls.Text();
        var temp21 = new Fuse.Drawing.StaticSolidColor(float4(0.8f, 0f, 1f, 1f));
        _b = new Fuse.Controls.PageControl();
        var temp22 = new Fuse.Controls.Page();
        var temp23 = new Fuse.Controls.Text();
        var temp24 = new Fuse.Drawing.StaticSolidColor(float4(0.8f, 1f, 0f, 1f));
        var temp25 = new Fuse.Controls.Page();
        var temp26 = new Fuse.Controls.Text();
        var temp27 = new Fuse.Drawing.StaticSolidColor(float4(0f, 0.8f, 1f, 1f));
        var temp28 = new Fuse.Controls.Page();
        var temp29 = new Fuse.Controls.Text();
        var temp30 = new Fuse.Drawing.StaticSolidColor(float4(1f, 0f, 0.8f, 1f));
        ...
        _a.Name = "_a";
        _a.Children.Add(temp13);
        _a.Children.Add(temp16);
        ...
        temp20.Value = "A3";
        _b.Name = "_b";
        _b.Children.Add(temp22);
        _b.Children.Add(temp25);
        _b.Children.Add(temp28);
